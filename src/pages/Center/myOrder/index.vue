<template>
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <!-- 每一笔订单 -->
        <table class="order-item" v-for="order in myOrder.records.slice(0,3)" :key="order.id">
          <thead>
            <tr>
              <th colspan="5">
      ...
      <div class="choose-order">
        <!-- 分页器 -->
        <Pagination :pageNo='page' :pageSize='limit' :total='myOrder.total' :continuePage='5' @getPageNo='pageNo'></Pagination>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
